...
public class MyWalletActivity1 extends AppCompatActivity implements OneClickPaymentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewWallet = (TextView) findViewById(R.id.textWallet);
        ...
        buttonSubmit = (Button) findViewById(R.id.addMoney);

        button100.setText(getResources().getString(R.string.hint_rupee_symbol) + " " + oneHundred);
        button200.setText(getResources().getString(R.string.hint_rupee_symbol) + " " + twoHundred);
        button500.setText(getResources().getString(R.string.hint_rupee_symbol) + " " + fiveHundred);

        button100.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editTextAmount.setText(oneHundred);
            }
        });
        ...
        button200.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editTextAmount.setText(twoHundred);
            }
        });
        ...
        button500.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editTextAmount.setText(fiveHundred);
            }
        });
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (new ConnectionDetector(MyWalletActivity1.this).isConnectingToInternet()) {
                    //addWalletAmount();
                    enterAmount = editTextAmount.getText().toString();
//                    navigateToBaseActivity();

                    Intent intent = new Intent(MyWalletActivity1.this,WebViewActivity.class);
                    intent.putExtra(AvenuesParams.ACCESS_CODE, com.maks.farmfresh24.ccavenuepayment.Utility.Constants.ACCESS_CODE);
                    intent.putExtra(AvenuesParams.MERCHANT_ID, com.maks.farmfresh24.ccavenuepayment.Utility.Constants.MERCHANT_ID);
                    intent.putExtra(AvenuesParams.ORDER_ID, "mywallet");
                    intent.putExtra(AvenuesParams.CURRENCY, "INR");
                    intent.putExtra(AvenuesParams.AMOUNT, enterAmount);

                    intent.putExtra(AvenuesParams.REDIRECT_URL, com.maks.farmfresh24.ccavenuepayment.Utility.Constants.RESP_HENDLR_URL);
                    intent.putExtra(AvenuesParams.CANCEL_URL, com.maks.farmfresh24.ccavenuepayment.Utility.Constants.RESP_HENDLR_URL);
                    intent.putExtra(AvenuesParams.RSA_KEY_URL, com.maks.farmfresh24.ccavenuepayment.Utility.Constants.RSA_URL);
        ...
        OnetapCallback.setOneTapCallback(MyWalletActivity1.this);
    ...
    public void viewWalletAmount() {
        AppPreferences app = new AppPreferences(MyWalletActivity1.this);
        double walletAmount = Double.parseDouble(app.getWalletAmount());
        String formattedData = String.format("%.02f", walletAmount);
        textViewWallet.setText(getResources().getString(R.string.hint_rupee_symbol) + " " + String.valueOf(formattedData));
    }

    private void getWalletAmount() {
        String req = "{\"method\":\"get_wallet_amount\",\"email\":\"" + new AppPreferences(MyWalletActivity1.this).getEmail() + "\"}";

        Log.e("request", req);

        new MyWalletActivity1.HttpAsyncTaskGet().execute(Constants.WS_URL, req);

    }

    private void addWalletAmount() {
        String req = "{\"method\":\"add_wallet_amount\",\"email\":\"" + new AppPreferences(MyWalletActivity1.this).getEmail() + "\",\"amount\":\"" + enterAmount + "\"}";

        Log.e("request", req);

        new MyWalletActivity1.HttpAsyncTaskAdd().execute(Constants.WS_URL, req);
    ...
    private class HttpAsyncTaskGet extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(MyWalletActivity1.this);
...
/*
    ...
    public void navigateToBaseActivity() {
        ...
        userCredentials = merchantKey + ":" + "anafali2000@gmail.com";// + new AppPreferences(MyWalletActivity.this).getEmail();
        ...
        double walletAmount = Double.parseDouble(enterAmount);
        String formattedData = String.format("%.02f", walletAmount);

        mPaymentParams.setKey(merchantKey);
        mPaymentParams.setAmount(enterAmount);
        /*
        ...
        * */
        ...
        mPaymentParams.setTxnId("" + System.currentTimeMillis() + n);
        //mPaymentParams.setTxnId("rdtgh43645df");

        mPaymentParams.setProductInfo("FarmFresh24");
        mPaymentParams.setFirstName(new AppPreferences(MyWalletActivity1.this).getFname());
        mPaymentParams.setEmail(new AppPreferences(MyWalletActivity1.this).getEmail());
        mPaymentParams.setPhone("7709031689");
    ...
    public void generateHashFromServer(PaymentParams mPaymentParams) {
        ...
        MyWalletActivity1.GetHashesFromServerTask getHashesFromServerTask = new MyWalletActivity1.GetHashesFromServerTask();
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MyWalletActivity1.this);
